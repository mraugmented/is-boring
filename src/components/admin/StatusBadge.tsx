...
const statusStyles: Record<string, { bg: string; text: string; dot?: string }> = {
  ...
  outreach_sent: { bg: 'bg-indigo-500/10', text: 'text-indigo-500', dot: 'bg-indigo-500' },
  replied: { bg: 'bg-teal-500/10', text: 'text-teal-500', dot: 'bg-teal-500' },
  meeting_booked: { bg: 'bg-amber-500/10', text: 'text-amber-500', dot: 'bg-amber-500' },
  closed_won: { bg: 'bg-green-500/10', text: 'text-green-500', dot: 'bg-green-500' },
  closed_lost: { bg: 'bg-red-500/10', text: 'text-red-500', dot: 'bg-red-500' },
  onboarding: { bg: 'bg-orange-500/10', text: 'text-orange-500', dot: 'bg-orange-500' },
  trial: { bg: 'bg-cyan-500/10', text: 'text-cyan-500' },
  paid: { bg: 'bg-green-500/10', text: 'text-green-500', dot: 'bg-green-500' },
  overdue: { bg: 'bg-red-500/10', text: 'text-red-500', dot: 'bg-red-500' },
  none: { bg: 'bg-[var(--bg-muted)]', text: 'text-[var(--text-tertiary)]' },
